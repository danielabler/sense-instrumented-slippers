...
if __name__ == '__main__':
    ...
    ap.add_argument("-o", "--output", type=str, default="False", help="output directory")
    ...
    np.save(p_out.joinpath("calibration_matrix"), mtx)
    np.save(p_out.joinpath("distortion_coefficients"), dist)
